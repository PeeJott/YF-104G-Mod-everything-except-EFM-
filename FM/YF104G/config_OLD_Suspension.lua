...
suspension 			= {
	  { -- NOSE WHEEL
		  ...
		  wheel_damage_speedX					= 225.0,--NEU übernommen von F16
		  wheel_damage_delta_speedX				= 22.5,--NEU übernommen von F16
	  ...
	  { -- LEFT WHEEL
		  ...
		  wheel_glide_friction_factor   		= 0.65 ,
		  wheel_damage_force_factor     		= 500.0,--war 450
		  wheel_damage_speedX					= 225,--NEU; F16 übernommen
		  wheel_damage_delta_speedX				= 22.5,--NEU F16 übernommen
...
cs_shakeFreq 				= 	5, -- shake frequency NEW // NEW 5
