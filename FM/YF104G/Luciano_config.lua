...
suspension 			= {
	  ...
	  { -- LEFT WHEEL
		  ...
		  amortizer_spring_force_factor   		= 11000000.0, -- force = spring_force_factor * pow(reduce_length, amortizer_spring_force_factor_rate
		  amortizer_spring_force_factor_rate  	= 3,
		  amortizer_static_force     			= 8000.0,
	  ...
	  {  -- RIGHT WHEEL
		  ...
		  amortizer_max_length    		 		= 0.228,
		  amortizer_basic_length     			= 0.228,
		  amortizer_spring_force_factor   		= 11000000.0, -- 10000 -- force = spring_force_factor * pow(reduce_length, amortizer_spring_force_factor_rate
		  amortizer_spring_force_factor_rate  	= 3,
		  amortizer_static_force     			= 8000.0,
		  amortizer_reduce_length     			= 0.21,
		  amortizer_direct_damper_force_factor 	= 50000.0,
