...
local mainGear = {
	...
	amortizer_max_length					= 0.228, --3D Modell
	amortizer_basic_length					= 0.228, --3D Modell
	amortizer_spring_force_factor			= 40000000.0, --war 4000000.0 //11000000.0, --F16 = 2.1e+7,  F15 = 990000.0,(reduce_length)
	amortizer_spring_force_factor_rate		= 3,
	amortizer_static_force					= 1000,
	amortizer_reduce_length					= 0.08, --F-16C = 0.05,//war 0.221
...
suspension 			= {
	  { -- NOSE WHEEL
			...
			moment_limit					= 750.0,--was ist das denn genau? Das "Moment" welches das Rad aufnehmen kann?
			damper_coeff					= 300.0,
			...
			wheel_radius								= 0.22,	-- Ø 0.44 / 2 // geänder von 0.44/2 auf 0.32/2
			wheel_static_friction_factor				= 0.65,
			wheel_side_friction_factor					= 0.60,--da das Bugrad aktuell zu schnell "rutscht" habe ich es mal angehoben. alt = 0.45 
