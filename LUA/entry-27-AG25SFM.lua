...
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/Views_Su27Pit.lua")
make_view_settings('VSN_F104G', ViewSettings, SnapViews)
make_flyable('VSN_F104G',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 3}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/Views_Su27Pit.lua")
make_view_settings('VSN_F104G_AG', ViewSettings, SnapViews)
make_flyable('VSN_F104G_AG',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 54}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/Views_Su27Pit.lua")
make_view_settings('VSN_F104S', ViewSettings, SnapViews)
make_flyable('VSN_F104S',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 3}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
dofile(current_mod_path.."/Views_Su27Pit.lua")
make_view_settings('VSN_F104S_AG', ViewSettings, SnapViews)
make_flyable('VSN_F104S_AG',current_mod_path..'/Cockpit/KneeboardRight/',{nil, old = 54}, current_mod_path..'/comm.lua')--SFM
-------------------------------------------------------------------------------------
