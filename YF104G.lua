...
YF_104G =  {
		...
		Name 			= 'YF104G',--AG
		DisplayName		= _('YF-104G Starfighter'),--AG
        Picture 		= "YF104G.png",
        Rate 			= "50",
        Shape			= "YF104G",--AG	
	...
	Categories= {"{78EFB7A2-FD52-4b57-A6A6-3BF0E1D6555F}", "Interceptor",},
	    ...
	    nose_gear_amortizer_normal_weight_stroke 	=  -0.05,   -- up
	    nose_gear_wheel_diameter 	                =  0.44, -- 3D Modell
	
	    main_gear_pos 						 	    = {-0.8, -1.823, 1.270}, -- changed back
	    main_gear_amortizer_direct_stroke	 	    =  0.12, --  down from main_gear_pos !!!
	    main_gear_amortizer_reversal_stroke  	    =  -0.12, --  up
	    main_gear_amortizer_normal_weight_stroke    =  -0.08,-- down from main_gear_pos
	...
	Pylons =     {
        ...
        pylon(2, 0, -1.200, 0.000, -3.47000,
            ...
            },
            {
				...
				{ CLSID = "{VSN_F104G_L_PTB}", arg_value = 0.7,attach_point_position = {0.0, 0.0 , 0.0 } },
            }
         ),
		 ...
		 pylon(4, 0, -0.800, -0.310, -1.900,
            ...
            },
            {
				...
				{ CLSID = "{LAU-7 - AIM-9L}", arg_value = 0.0}, --AIM-9L NEU
				--{ CLSID = "{F4-2-AIM9L}", arg_value = 0.0}, --2x AIM-9L NEU //sehen scheiße aus
				{ CLSID = "LAU-105_2*AIM-9L", arg_value = 0.0}, -- AIM-9Lx2//NEU zum Testen von der A10A
				{ CLSID = "{AIM-9B}", arg_value = 0.5},--AIM-9B NEU
				{ CLSID = "{D5D51E24-348C-4702-96AF-97A714E72697}", arg_value = 0.0}, -- MER MK82 x 2 //NEU
				--{ CLSID = "{C535596E-F7D2-4301-8BB4-B1658BB87ED7}", arg_value = 0.0},-- MER BL755 x 2 //NEU 
		...
		pylon(8, 0, -0.800, -0.310, 1.900,
            ...
            },
            {
				...
				{ CLSID = "{LAU-7 - AIM-9L}", arg_value = 0.0}, --AIM-9L NEU
				--{ CLSID = "{F4-2-AIM9L}", arg_value = 0.0}, --2x AIM-9L NEU/sehen scheiße aus
				{ CLSID = "LAU-105_2*AIM-9L", arg_value = 0.0}, -- AIM-9Lx2 // NEU von der A10A
				{ CLSID = "{AIM-9B}", arg_value = 0.0},--AIM-9B NEU
				{ CLSID = "{D5D51E24-348C-4702-96AF-97A714E72697}", arg_value = 0.0}, -- MER MK82 x 2 //NEU
				--{ CLSID = "{C535596E-F7D2-4301-8BB4-B1658BB87ED7}", arg_value = 0.0},-- MER BL755 x 2 //NEU 
				{ CLSID = "{VSN_F104G_PTB}", arg_value = 0.7,attach_point_position = {0.0, 0.0 , 0.0 } },
		...
		pylon(10, 0, -1.200, 0.00, 3.47000,
            ...
            },
            {
			    ...
			    { CLSID	= "{A4BCC903-06C8-47bb-9937-A30FEDB4E744}", arg_value = 0.5}, --Smokewinder - white
			    { CLSID	= "{A4BCC903-06C8-47bb-9937-A30FEDB4E745}", arg_value = 0.5}, --Smokewinder - yellow
				{ CLSID = "{VSN_F104G_R_PTB}", arg_value = 0.7,attach_point_position = {0.0, 0.0 , 0.0 } },
            }
        ),
		pylon(11, 0, 0, 0, 0,
            {
